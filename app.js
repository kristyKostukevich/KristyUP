...
//             id: '10',
//             isDeleted: 'false',
//             title: 'При госзакупках в Беларуси разворовывается $1 млрд',
...
//     ];
//     articles.drop();
//     articles.insertMany(articles2, function(err, result){
//         db.close();
//     });
// });
// mongoClient.connect(url, function (err, db) {
//     let tags = db.collection("tags");
//     var tags2 = [{name:"Политика"},
//         {name:"музыка"},
//         {name:"спорт"},
//         {name:"архитектура"},
//         {name:"минск"},
...
//         {name:"Котики"}];
//     tags.drop();
//     tags.insertMany(tags2, function(err, result){
//         db.close();
//     });
// });
...
//         var usPass = [{user:"admin",password:"admin"},
//                  {user:"user",password:"user"},
//                  {user:"mr.Sad",password:"2244msd"},
//                  {user:"mrs.Sad",password:"2244wsd"},
//                  {user:"mr.Glad",password:"2244mgl"},
//                  {user:"mrs.Glad",password:"2244wgl"},
//                  {user:"mr.Proud",password:"2244mpr"},
//                  {user:"mrs.Proud",password:"2244wpr"},
//                  {user:"mr.Calm",password:"2244mcl"},
//                  {user:"mrs.Calm",password:"2244wcl"}
//                  ];
//         collection.drop();
//         collection.insertMany(usPass, function(err, result){ db.close(); });
//     });
